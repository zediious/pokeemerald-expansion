...
static const struct SpriteFrameImage sPicTable_NewPoliceman[] = {
...
static const struct SpriteFrameImage sPicTable_ConstWorker[] = {
    overworld_ascending_frames(gObjectEventPic_ConstWorker, 2, 4),
};
