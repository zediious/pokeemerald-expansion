...
const struct Tileset gTileset_ZEDPrimaryTest =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_ZEDPrimaryTest,
    .palettes = gTilesetPalettes_ZEDPrimaryTest,
    .metatiles = gMetatiles_ZEDPrimaryTest,
...
const struct Tileset gTileset_DesertMisc =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_DesertMisc,
    .palettes = gTilesetPalettes_DesertMisc,
    .metatiles = gMetatiles_DesertMisc,
    .metatileAttributes = gMetatileAttributes_DesertMisc,
    .callback = NULL,
};

const struct Tileset gTileset_IgrisUnderground =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
...
const struct Tileset gTileset_Igris_Ruins =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Igris_Ruins,
    .palettes = gTilesetPalettes_Igris_Ruins,
    .metatiles = gMetatiles_Igris_Ruins,
