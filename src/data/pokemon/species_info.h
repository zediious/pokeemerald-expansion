...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_MANDRASEAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SCORCHING_POWER, ABILITY_OWN_TEMPO, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Mandrasear"),
        .cryId = CRY_MEGA_SIMISEAR,
        .natDexNum = NATIONAL_DEX_MANDRASEAR,
        .levelUpLearnset = sMandrasearLevelUpLearnset,
    ...
    [SPECIES_BONOSAGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PHOTOSYNTHESIS, ABILITY_OWN_TEMPO, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Bonosage"),
        .cryId = CRY_MEGA_SIMISAGE,
        .natDexNum = NATIONAL_DEX_BONOSAGE,
        .levelUpLearnset = sBonosageLevelUpLearnset,
    ...
    [SPECIES_PONGAPOUR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FROZEN_BODY, ABILITY_OWN_TEMPO, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Pongapour"),
        .cryId = CRY_MEGA_SIMIPOUR,
        .natDexNum = NATIONAL_DEX_PONGAPOUR,
        .levelUpLearnset = sPongapourLevelUpLearnset,
    ...
    [SPECIES_INNONK] =
    {
        ...
        .backPic = gMonBackPic_Innonk,
        .backPicSize = MON_COORDS_SIZE(48, 56),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = gMonPalette_Innonk,
        .shinyPalette = gMonShinyPalette_Innonk,
        .iconSprite = gMonIcon_Innonk,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        .enemyMonElevation = 1,
        .levelUpLearnset = sInnonkLevelUpLearnset,
        .teachableLearnset = sInnonkTeachableLearnset,
