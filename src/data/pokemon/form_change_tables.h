...
{
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_WISHIWASHI_SCHOOL, ABILITY_SCHOOLING, HP_HIGHER_THAN,   25, 15},
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_WISHIWASHI_SOLO,   ABILITY_SCHOOLING, HP_LOWER_EQ_THAN, 25},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_WISHIWASHI_SCHOOL, ABILITY_SCHOOLING, HP_HIGHER_THAN,   25, 15},
