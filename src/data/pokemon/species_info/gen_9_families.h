...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_PAWMO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_PAWMOT, CONDITIONS({IF_MIN_OVERWORLD_STEPS, 1000})}),
    },
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_BRAMBLEGHAST, CONDITIONS({IF_MIN_OVERWORLD_STEPS, 1000})}),
    },
    ...
    [SPECIES_RELLOR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_RABSCA, CONDITIONS({IF_MIN_OVERWORLD_STEPS, 1000})}),
    },
    ...
    [SPECIES_GIMMIGHOUL_CHEST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_GHOLDENGO, CONDITIONS({IF_BAG_ITEM_COUNT, ITEM_GIMMIGHOUL_COIN, 999})}),
    },
