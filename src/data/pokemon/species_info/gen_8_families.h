...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_DIPPLIN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_HYDRAPPLE, CONDITIONS({IF_KNOWS_MOVE, MOVE_DRAGON_CHEER})}),
    },
    ...
    [SPECIES_CLOBBOPUS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_GRAPPLOCT, CONDITIONS({IF_KNOWS_MOVE, MOVE_TAUNT})}),
    },
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_SNOM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_FROSMOTH, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD},{IF_TIME, TIME_NIGHT})}),
    },
