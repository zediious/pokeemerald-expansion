...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_STEENEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_TSAREENA, CONDITIONS({IF_KNOWS_MOVE, MOVE_STOMP})}),
    },
    ...
    [SPECIES_ORANGURU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MINDBENDING, ABILITY_AURA_BREAK, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_PASSIMIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RUSHDOWN, ABILITY_AURA_BREAK, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_TYPE_NULL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_SILVALLY_NORMAL, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})}),
    },
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, heldItem)\
    ...
    [SPECIES_POIPOLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 10, SPECIES_NAGANADEL, CONDITIONS({IF_KNOWS_MOVE, MOVE_DRAGON_PULSE})}),
    },
