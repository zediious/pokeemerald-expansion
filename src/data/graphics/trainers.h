...
const u8 gTrainerBackPic_Noland[] = INCBIN_U8("graphics/trainers/back_pics/factory_head_noland.4bpp");
...
const u16 gTrainerBackPicPalette_Noland[] = INCBIN_U16("graphics/trainers/back_pics/factory_head_noland.gbapal");
