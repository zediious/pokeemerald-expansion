...
static const u8* const sTrainerSlides[DIFFICULTY_COUNT][TRAINER_PARTNER(PARTNER_COUNT)][TRAINER_SLIDE_COUNT] =
{
    [DIFFICULTY_NORMAL] =
    {
        ...
        {
            [TRAINER_SLIDE_BEFORE_FIRST_TURN] = COMPOUND_STRING("Let's have a great battle!!{PAUSE_UNTIL_PRESS}"),
        ...
        [TRAINER_PARTNER(PARTNER_JORDAN_PANPOUR_01)] =
        {
            ...
            [TRAINER_SLIDE_PLAYER_LANDS_FIRST_SUPER_EFFECTIVE_HIT] = COMPOUND_STRING("Awesome hit!{PAUSE_UNTIL_PRESS}"),
        },
