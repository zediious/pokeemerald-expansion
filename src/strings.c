...
const u8 gText_Badges[] = _("Ribbons"); // Unused
...
const u8 gText_DexHoennTitle[] = _("Vulias Dex");
...
const u8 gText_DexHoennDescription[] = _("Vulias region's Pokédex");
...
const u8 gText_DexSearchDontSpecify[] = _("Don't Specifiy.");
...
const u8 gText_RepelEffectsEnabled[] = _("You opened the Nozzle\non the Ultra Repel.{PAUSE_UNTIL_PRESS}");
const u8 gText_RepelEffectsDisabled[] = _("You closed the Nozzle\non the Ultra Repel.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_First_PM[] = _("Frist");
...
const u8 gText_DexHoenn[] = _("Vulias");
...
const u8 gText_SavingBadges[] = _("Ribbons");
...
const u8 gText_SideQuestName_4[] = _("Ancient Knowledge");
...
const u8 gText_MainQuestMap_08[] = _("Liordun Town");
...
const u8 gText_SideQuestDesc_4[] = _("An Old Man in the Igris Desert has\nlost their journal! I agreed to get it\nfrom the Mountain Tunnel.");
...
const u8 gText_SideQuestDoneDesc_4[] = _("I retrieved the Old Man's journal, and\ngot a Tera Orb!");
...
const u8 gText_SideQuestMap4[] = _("North Igris - House");
...
const u8 gText_ScaleTrainers[] = _("Scale Trainers");
