...
#define VAR_DREAM_ENTERED                                0x404E // Player entered dream room after intro
...
#define VAR_WOLTIA_DISABLETRAINERS_TRIGGER               0x4083 // Trigger to disable tourney trainers ahead of time
...
#define VAR_IGRIS_DIGDUNGEON_DOHOP                       0x40A1 // Whether to do spit/hop out of sand hole on entry to Igris
...
#define VAR_IGRIS_UNDER_DOHOPLEFT                        0x40A8 // Whether to do spit/hop out of sand hole to left on entry to Igris Underground
...
#define VAR_IGRIS_OLDMAN_STATE                           0x40B8 // State of Old Man living in Igris Desert
#define VAR_MT_PYRE_STATE                                0x40B9
#define VAR_NEW_MAUVILLE_STATE                           0x40BA
#define VAR_IGRIS_DIGBUFFER_DOTELE                       0x40BB // Frame table var for dig dungeon scene
...
#define VAR_DEXNAV_SPECIES                               0x40DB // USED FOR DEXNAV
#define VAR_DEXNAV_STEPS                                 0x40DC // USED FOR DEXNAV
...
#define VAR_SWITCHBEHAVIOR_SETTING                       0x40E5 // User setting for battle switch behavior
